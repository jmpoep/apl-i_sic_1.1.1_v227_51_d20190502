...
typedef union {
  struct {
    //
    // ddr401_PM module reset from config register
    //
    // Bits[0:0], RW, default = 0x0
    //
    UINTX pm_pmrst_b : 1;
...
typedef union {
  struct {
    ...
    //
    // dll ddr401_comp clak gate overiride
    //
    // Bits[29:29], RW, default = 0x0
    //
    UINTX pm_dllcomp_clkgate_ovr : 1;
    //
    // Force ddr401_PM LDO ddr401_Comp. When set to 1'b1, this results in ddr401_PM forcing
    // LDO Offset ddr401_comp when exiting PM3. Current recommendation is to enable this
    // in PSMI mode only.
    //
...
typedef union {
  struct {
    //
    // ddr401_COMP Enable Overide
    //
    // Bits[0:0], RW, default = 0x0
    //
    UINTX pm_comp_en_ovr : 1;
    //
    // ddr401_PM adpll lock
    //
    // Bits[1:1], RO/V, default = 0x0
    //
    ...
    UINTX pm_pien_ovr : 1;
    //
    // ddr401_DQRX FIFO Reset Override
    //
    // Bits[8:8], RW, default = 0x0
    //
    ...
    UINTX pm_hvm_req : 1;
    //
    // ddr401_PM Spid Reset Override
    //
    // Bits[20:20], RW, default = 0x0
    //
    UINTX pm_spidrst_b_ovr : 1;
    //
    // ddr401_PM Spid clkreq override
    //
    // Bits[21:21], RW, default = 0x0
    //
    UINTX pm_spidclkreq_ovr : 1;
    //
    // ddr401_PM Spid clkreq Enable
    //
    // Bits[22:22], RW, default = 0x1
    //
    UINTX pm_spidclkreq_en : 1;
    //
    // Reserved
    //
...
typedef union {
  struct {
    ...
    //
    // ddr401_dllcomp clock disable  gate delay
    //
    // Bits[7:4], RW, default = 0x0
    //
    ...
    //
    // ddr401_dllcomp clock enable  gate delay
    //
    // Bits[15:12], RW, default = 0x0
    //
...
typedef union {
  struct {
    ...
    UINTX pm_sw_req : 1;
    //
    // ddr401_PM software acknowledge
    //
...
#endif // MEM_SV_HOOKS
    //
    // State of Power Management logic. [4]: busy. [3:0] : ddr401_PM state
    //
...
#define DPIC_PM_DELAY10_DPIC_REG                           0x00000144
#ifndef ASM_INC
typedef union {
  struct {
    //
...
#endif // MEM_SV_HOOKS
    //
    // this tells a timer to start the periodic ddr401_comp cycle when this number of
    // cycles are completed. Usually this is programmed to 'h7d00 for a 4s delay between
    // two periodic ddr401_comp cycles.
    //
