...
//13=4-03-2014: Trwdr LPDDR4 14-15-15 Excel:23 Sim Model: 24
  ...
  {  BxtTimingTxp,         6,    8,   },
  {  BxtTimingTcke,        6,    8,   },
  {  BxtTimingTrdpden,    34,   41,   },
  {  BxtTimingTwrpden,    44,   55,   },
  {  BxtTimingTrrsr,      16,   16,   },
  {  BxtTimingTrrdr,      20,   21,   },
  {  BxtTimingTwwsr,      16,   16,   },
  {  BxtTimingTwwdr,      23,   24,   },
  {  BxtTimingTwrsr,      37,   46,   },
  {  BxtTimingTwrdr,      20,   21,   },
  {  BxtTimingTrwsr,      26,   27,   },
  {  BxtTimingTrwdr,      26,   27,   },
  {  BxtTimingTzqcs,       0,    0,   },
  {  BxtTimingTzqlat,     24,   32,   },
  {  BxtTimingTccdmw,     32,   32,   },
  {  BxtTimingTcksrx,      3,    3,   },
  {  BxtTimingTcksre,      5,    6,   },
  {  BxtTimingTrppb,      15,   20,   },
  {  BxtTimingTmod ,      12,   15,   },
  {  BxtTimingTrfc6Gb,    96,   96,   },
  {  BxtTimingTxsr6Gb,   102,  104,   },
...
UINT16 TimingParamsOver255[][MaxMemoryTypeFreqConfig] = {
  {  BxtTimingTrfc,      144,  216,  },//12
  {  BxtTimingTrefi,    3125, 4167,  },//13
  {  BxtTimingTzqcl,       0,    0,  },//27
  { BxtTimingTzqoper,    800, 1067,  },//34
  {  BxtTimingTrfc4Gb,   104,  139,  },//36
  {  BxtTimingTrfc8Gb,   144,  192,  },//38
  {  BxtTimingTrfc12Gb,  224,  299,  },//39
  {  BxtTimingTrfc16Gb,  224,  299,  },//40
  {  BxtTimingTxsr4Gb,   110,  147,  },//41
  {  BxtTimingTxsr8Gb,   150,  200,  },//43
  {  BxtTimingTxsr12Gb,  230,  307,  },//44
  {  BxtTimingTxsr16Gb,  230,  307,  },//45
};
...
CONTROLKNOBS ControlKnobsReadLP4[] = {
  ...
  {RxDqsDelay, -1, RxDqBitDelay, {0 , _12X},                            0xf, {0,  _12X}                           , { RT_STEP1_3_PISTEPLARGE, RT_STEP1_3_PISTEPMEDIUM, RT_STEP1_3_PISTEPSMALL}, MMRC_ABS, RT_BYTE_SHARING                        , RT_BIT_SHARING|TIMING_SHARED, "PI \0", 2+2*RT_CTLE_ENABLE-1, 0,  0, 0, -1, READTRAINING_ENTRY, FALSE, 1, NUM_SAMPLES_TO_CENTERT, GenericMemoryTest},
  {RxVref    , -1,  -1          , {RT_STEP1_VREFSTART_LP4 ,  RT_STEP1_VREFSTART_LP4}, -1, {RT_STEP1_VREFMIN,  RT_STEP1_VREFMAX}, { RT_STEP2_VREFSTEP, 0, 0}                                   , MMRC_ABS, RANK_SHARED | KNOB_SHARED | BIT_SHARED | TIMING_SHARED , -1           , "VRF\0", 2+2*RT_CTLE_ENABLE-1, 5, 50, 5, RT_STEP1_VREFSTEP,READTRAINING_ENTRY, FALSE, 1, NUM_SAMPLES_TO_CENTERV, GenericMemoryTest},
#if RT_CTLE_ENABLE==1
  {Ctle_Res  , -1, -1          , {0                  ,  3}                 , -1, { 0              ,  3                }, { 1, 0, 0}, MMRC_ABS, RT_CTLE_SHARED, -1, "Cc", 2+2*RT_CTLE_ENABLE-1, 0, 0, 0, 1,READTRAINING_ENTRY, FALSE, GenericMemoryTest},
  {Ctle_Cap  , -1, -1          , {0                  ,  3}                 , -1, { 0              ,  3                }, { 1, 0, 0}, MMRC_ABS, RT_CTLE_SHARED, -1, "Cr", 2+2*RT_CTLE_ENABLE-1, 0, 0, 0, 1,READTRAINING_ENTRY, FALSE, GenericMemoryTest},
#endif
};
...
CONTROLKNOBS ControlKnobsWriteLP4[] = {
  ...
  {TxDqDelay,   -1, TxDqBitDelay, {0,0}                             , 31, {_n1X,  _1X}                       , { WT_STEP1_3_PISTEPLARGE, WT_STEP1_3_PISTEPMEDIUM, WT_STEP1_3_PISTEPSMALL}, REL     , WT_BYTE_SHARING     , WT_BIT_SHARING, "PI \0", 2-1, 0,  0,                 0, -1,READTRAINING_ENTRY, TRUE, 1, NUM_SAMPLES_TO_CENTERT, GenericMemoryTest},
  {TxVref,      -1,         -1, {WT_STEP1_VREFSTART_LP4 ,  WT_STEP1_VREFSTART_LP4}, -1, {WT_STEP1_VREFMIN_LP4,  WT_STEP1_VREFMAX_LP4}, { WT_STEP2_VREFSTEP_LP4, 0, 0}                                                , MMRC_ABS, STROBE_SHARED | KNOB_SHARED | BIT_SHARED , -1          , "VRF\0", 2-1, 5, 50, WT_STEP1_VREFSTEP_LP4, WT_STEP1_VREFSTEP_LP4,READTRAINING_ENTRY, TRUE, 1, NUM_SAMPLES_TO_CENTERV, GenericMemoryTest},
};
...
CONTROLKNOBS ControlKnobsCmdCtl[] = {
  // Control                   Start       Range      Step     Rel/Abs      Shared
  //  Knob                     Value       Value      Value    Flags         Flags
  {CmdGrp0,               -1, -1, {0 , 0}, -1, {  _n12X,  _12X}, { 5, 0, 0}, REL, RANK_SHARED | BIT_SHARED | STROBE_SHARED | KNOB_SHARED, 0xff,"Cmd",2, 0, 0, 0,  0xFF, READTRAINING_ENTRY, TRUE,2, NUM_SAMPLES_TO_CENTERT, GenericCmdMemoryTest},
  {CtlGrp0,               -1, -1, {0 , 0}, -1, {  _n12X,  _12X}, { 5, 0, 0}, REL, BIT_SHARED | STROBE_SHARED | KNOB_SHARED, 0xff,"Ctl",2, 0, 0, 0, 0xFF, READTRAINING_ENTRY, TRUE,2, NUM_SAMPLES_TO_CENTERT, GenericCmdMemoryTest},
  {TxCaVref,              -1, -1, {400 , 400}, -1, {100,  400}, { 401, 0, 0}, MMRC_ABS, RANK_SHARED |STROBE_SHARED | KNOB_SHARED | BIT_SHARED,-1,"Vre",2, 5, 50, 5, 5, READTRAINING_ENTRY, TRUE,2, NUM_SAMPLES_TO_CENTERV, GenericCmdMemoryTest},
};
...
/**
  ...
  The TimingParams arrays are 1 based, whereas the Config is 0 based.
    We are removing all indices except 1600 LPDDR4 and 2133 LPDDR4.
  This saves on code size.
