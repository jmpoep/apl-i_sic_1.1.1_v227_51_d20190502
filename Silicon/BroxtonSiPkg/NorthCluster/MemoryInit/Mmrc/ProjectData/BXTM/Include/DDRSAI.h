...
#define SAI_RW_REG1_DDRSAI_REG                             0x00000050
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} SAI_RW_REG1_DDRSAI_STRUCT;
#endif // ASM_INC

#define SAI_RW_REG1_1_DDRSAI_REG                           0x00000054
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} SAI_RW_REG1_1_DDRSAI_STRUCT;
#endif // ASM_INC

#define SAI_RW_REG2_DDRSAI_REG                             0x00000058
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} SAI_RW_REG2_DDRSAI_STRUCT;
#endif // ASM_INC

#define SAI_RW_REG2_1_DDRSAI_REG                           0x0000005C
#ifndef ASM_INC
typedef union {
  struct {
    //
...
#define REG_POLICY1_DDRSAI_REG                             0x00000064
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} REG_POLICY1_DDRSAI_STRUCT;
#endif // ASM_INC

#define REG_POLICY2_DDRSAI_REG                             0x00000068
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} REG_POLICY2_DDRSAI_STRUCT;
#endif // ASM_INC

#define REG_RSVD_DDRSAI_REG                                0x0000006C
#ifndef ASM_INC
typedef union {
  struct {
    //
